...
import kotlinx.android.synthetic.main.layout_building_card.view.*


class BuildingRecyclerAdapter(
...
//    private var items: List<Building> = buildingList
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return BuildingViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.layout_building_card, parent, false)
        )
    }
